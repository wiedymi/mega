...
import { streamToCb, promisify } from './util'
...
class File extends EventEmitter {
  ...
  async loadMetadataAsync () {
    return promisify(this.loadMetadata.bind(this)).call(this, arguments)
  }

  async downloadAsync () {
    return promisify(this.download.bind(this)).call(this, arguments)
  }

  async loadAttributesAsync () {
    return promisify(this.loadAttributes.bind(this)).call(this, arguments)
  }

  async decryptAttributesAsync () {
    return promisify(this.decryptAttributes.bind(this)).call(this, arguments)
  }
