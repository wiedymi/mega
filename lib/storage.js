import { e64, d64, prepareKey, prepareKeyV2, formatKey, AES, constantTimeCompare } from './crypto'
...
class Storage extends EventEmitter {
  ...
  async loginAsync () {
    return promisify(this.login.bind(this)).call(this, arguments)
  }

  async reloadAsync () {
    return promisify(this.reload.bind(this)).call(this, arguments)
  }
  ...
  async getAccountInfoAsync () {
    return promisify(this.getAccountInfo.bind(this)).call(this, arguments)
  }
